                ...
                <div class="main">
                    ...
                    <div id="c1" class="card">
                        <div class="card-info">
                            ...
                            <div class="card-title">Jamshid</div>
                            <div class="card-subtitle">Tursunov</div>
                            <div class="card-social">
                                <li id="cs1" class="card-social-icon">
                                    <a href=""><i class="text-lg fa-brands fa-instagram"></i></a>
                                    Instagram
                                </li>
                                <li id="cs2" class="card-social-icon">
                                    <a href="https://t.me/jamshid194"><i class="text-lg fa-brands fa-telegram"></i></a>
                                   Telegram
                                </li>
